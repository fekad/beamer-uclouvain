\documentclass[11pt,t,aspectratio=1610,nonav]{beamer}
%\include{header}
...
\title[Introduction]{UCLouvain beamer template}
\subtitle{stay at home}

\author[S. Name]{Author S. Name}
\institute[UCLouvain]{MODL, IMCN, \\Université catholique de Louvain, Belgium}
...
\end{tikzpicture}
\centering
\includegraphics[width = 0.5\paperwidth]{UCLouvain_logo_dark_transparent.pdf}
\end{frame}
...
sdfsdsOptionally, you can add your own title page graphic by declaring \texttt{titlegraphic} (does not work in combination with \texttt{sedes} option).
...
\vspace{-12pt}
	\begin{figure}
	\centering
	\includegraphics[width=0.6\textwidth]{figures/example_figure.pdf}
